...
class SubScan extends StatefulWidget {
  String eventTitle,eventPhoto;
  SubScan({this.eventTitle,this.eventPhoto});
  @override
      ...
      actions: <Widget>[
          IconButton(
            ...
            onPressed: () async {
              ...
              MaterialPageRoute(builder: (context)=>Attenneds(eventtitle :widget.eventTitle)));
...
class CrudFire {
  Future<void> create(data) async {
    Firestore.instance.collection('attendees').document().setData(data);
  }
}
