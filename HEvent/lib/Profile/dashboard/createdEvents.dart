...
import 'package:HEvent/Profile/dashboard/Charts.dart';
import 'package:HEvent/QR/qrGenerete.dart';
import 'package:HEvent/scaning/scanpage.dart';
...
class createdEvents extends StatefulWidget {
  ...
  createdEvents(
      ...
      this.speaker});
  @override
  _createdEventsState createState() => _createdEventsState();
}
 ...
 SharedPreferences pref;
  ...
  charts() {
    ...
    Navigator.of(context).push(new MaterialPageRoute(builder: (context) {
      return new ScanPage(title: widget.title,photo: widget.photo);//Charts1
    }));
  }
