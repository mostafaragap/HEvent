...
class suggestsBasedPlace extends StatefulWidget {
  String type,address;
  suggestsBasedPlace({this.type,this.address});
  @override
  _suggestsBasedPlaceState createState() => _suggestsBasedPlaceState();
}

class _suggestsBasedPlaceState extends State<suggestsBasedPlace> {
          ...
          Container(
            ...
            stream: name != "" && name != null
                ? Firestore.instance
                    .collection('Events')
                    .where("serchIndex", arrayContains: name)
                    .where("address", isEqualTo: widget.address).limit(7)
                    .snapshots()
                : Firestore.instance
                    .collection("Events")
                    .where("address", isEqualTo: widget.address).limit(7)
